...
describe('Integration Tests', () => {
  describe('Template', () => {
    ...
    it('should handle full model template', () => {
      const template = new Template(
        SAMPLE_TEMPLATES_PATH,
        'sample-full-model.hbs',
      );
      template.generate(sampleModel);
  ...
  describe('FileHelper', () => {
    ...
    it('should get file information', () => {
      const fileInfos = FileHelper.getFileInformationSync(
        SAMPLE_TEMPLATES_PATH,
        false,
      );
    ...
    it('should check file existence', async () => {
      const exists = await FileHelper.exists(
        path.join(SAMPLE_TEMPLATES_PATH, 'sample.hbs'),
      );
    ...
    it('should normalize paths correctly', () => {
      ...
      expect(FileHelper.normalizePath('/path/to/dir/')).toBe('/path/to/dir/');
      expect(FileHelper.normalizePath('C:\\path\\to\\dir')).toBe(
        'C:\\path\\to\\dir/',
      );
    });
  });
